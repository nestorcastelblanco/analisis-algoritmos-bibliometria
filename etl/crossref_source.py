# etl/sources/crossref_source.py
...
params = {
"query": query,
"filter": f"publisher-name:{publisher}", # ej. 'SAGE Publications' o 'Association for Computing Machinery'
...
# Preferir link con intended-application text-mining o PDF
link_url = None
...
abstract = it.get("abstract") # puede venir en JATS; tu pipeline puede limpiarlo
